...
public class StubIntegrationImmutableTest {
    private static final Logger LOGGER = LoggerFactory.getLogger(StubIntegrationImmutableTest.class);
    private final ViPRCoreClient client;
    @Autowired
    private PropertiesResolver propertiesResolver;

    public StubIntegrationImmutableTest() {
